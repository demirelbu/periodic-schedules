...
if __name__ == "__main__":
    ...
    sequence = np.array([1, 2, 1, 2, 3, 2], dtype=int)
    """
    # create a random communication sequence
    sequence = np.random.randint(1, 4, size=7)
    """
    # compute the cost
    cost = QuadraticCost(sequence)
    print(
        "For the communication sequence of {}, the control cost is computed as {:3.4f}.".format(
            sequence,
            cost))
